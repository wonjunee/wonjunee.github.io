...
%---------------------------------------------------------
\cvtalk
    {Computational Math Seminar} % Seminar https://research.osu.edu/2026-ai-research-summit
    {The Ohio State University}
    {Dynamics Over Landscape: The Emergence of Linear Separability via Spectral Alignment in Contrastive Learning} % talk subject
    {2026} % Date(s)
\cvtalk
    {Control and Optimization Seminar} % Seminar https://research.osu.edu/2026-ai-research-summit
    {Louisiana State University}
    {Dynamics Over Landscape: The Emergence of Linear Separability via Spectral Alignment in Contrastive Learning} % talk subject
    {2026} % Date(s)
\cvtalk
    {2026 AI Research Summit} % Seminar https://research.osu.edu/2026-ai-research-summit
    {The Ohio State University}
    {Geometry-preserving encoder and decoder on latent diffusion models} % talk subject
    {2026} % Date(s)
\cvtalk
    {Level Set Collective II} % Seminar
    {UCLA}
    {Geometry-preserving encoder and decoder on latent diffusion models} % talk subject
    {2025} % Date(s)
\cvtalk
    {SIAM Central States Section Annual Meeting 2025} % Seminar
    {Arkansas, US}
    {Geometry-preserving encoder and decoder on latent diffusion models} % talk subject
    {2025} % Date(s)
    ...
    {Efficient Algorithm for Multi-Species Tumor Growth Models} % talk subject
    {2025} % Date(s)
%====================================
\cvtalk
    {Computational and Applied Mathematics Seminar} % Seminar
...
\cvtalk
    ...
    {The Center for Communications Research-La Jolla}
    {Geometry-preserving encoder and decoder on latent diffusion models} % talk subject
    {2025} % Date(s)
\cvtalk
    {Applied Mathematics Seminar} % Seminar
    {Tufts University}
    {Geometry-preserving encoder and decoder on latent diffusion models} % talk subject
    {2025} % Date(s)
% \cvtalk
%     {Recruitment Seminar} % Seminar
%     {The Ohio State University}
%     {Geometry-preserving encoder and decoder on latent diffusion models} % talk subject
%     {2025} % Date(s)
%====================================
