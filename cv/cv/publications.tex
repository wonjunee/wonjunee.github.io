...
\begin{cvitems}
  ...
  \item M. Jacobs, \textbf{W. Lee}, \href{}{\textit{An efficient numerical scheme for tumor growth models}}, \textbf{In preparation}
    \medskip
  \item J. Calder, \textbf{W. Lee}, \href{https://arxiv.org/pdf/2503.10812}{\textit{Dynamics Over Landscape: The Emergence of Linear Separability via Spectral Alignment in Contrastive Learning}} (previously submitted in 2025 as `Understanding Contrastive Learning through Variational Analysis and Neural Network Optimization Perspectives'), \textbf{Submitted}
    \medskip
  \item \textbf{W. Lee}, L. Wang, W. Li, \href{}{\textit{Generalized Deep JKO: an IMEX particle method for kinetic Fokker-Planck equations}}, \textbf{Submitted}
    \medskip
  \item J. Gu, M. Mardani, \textbf{W. Lee}, D. Zou, G. Lerman, \textit{Demystifying Latent Space Diffusibility via Fisher Geometry}, \textbf{Submitted}
    \medskip
  \item Y. Yang, J. Li, Y. Quan, D. Zou, \textbf{W. Lee}, X. Li, G. Lerman, {\textit{Anomaly Detection in Ancient Ceramics Using Gromov-Wasserstein Regularized Hyperbolic Autoencoders}}, \textbf{Submitted} %preprint 2025   
    \medskip
